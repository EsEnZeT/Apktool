...
public final class ResTypeSpec {
    ...
    public static final String RES_TYPE_NAME_STYLES2 = "style3";
    public static final String RES_TYPE_NAME_STYLES2 = "style4";
    public static final String RES_TYPE_NAME_STYLES2 = "style5";
